...
ROUTING_RULES: list[tuple[re.Pattern[str], str, dict[str, Any]]] = [
    ...
    (re.compile(r"\b(next|upcoming|when is the next|list of) .{0,20}(holiday|bank holiday|day off)\b", re.I),
     "get_upcoming_holidays", {}),
    (re.compile(r"\bpublic holidays?\b.*\b(coming|next|upcoming|this year|left)\b", re.I),
     "get_upcoming_holidays", {}),
